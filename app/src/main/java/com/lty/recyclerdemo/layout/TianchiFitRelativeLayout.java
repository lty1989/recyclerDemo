...
public class TianchiFitRelativeLayout extends RelativeLayout {

    private final TianchiFitLayoutHelper mHelper = new TianchiFitLayoutHelper(this);

    public TianchiFitRelativeLayout(Context context) {
        super(context);
    }

    public TianchiFitRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TianchiFitRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
